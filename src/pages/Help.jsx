            ...
            <div className="container">
                ...
                <div className="help-content">
                    ...
                    <ul className="helptxt">
                        ...
                        <li className="helptxt"><strong>Как связаться с поддержкой?</strong> — Напишите на  <a href="mailto:ryuiop860@gmail.com">ryuiop860@gmail.com</a>.</li>
                    </ul>
                    <h2 className="helptxt">Контакты</h2>
                    <p className="helptxt">Email: <a href="mailto:ryuiop860@gmail.com">ryuiop860@gmail.com</a></p>
                    <p className="helptxt">Телефон: +7 (708) 246-03-44</p>
